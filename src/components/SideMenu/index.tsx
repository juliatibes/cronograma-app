...
<div>
    ...
    <ul className="side-menu-lista">
        ...
        <li> <CalendarMonth /> <a href="#">Professores</a></li>
        <li> <CalendarMonth /> <a href="#">Disciplinas</a></li>
        <li> <CalendarMonth /> <a href="#">Fases</a></li>
        <li> <CalendarMonth /> <a href="#">Cursos</a></li>
        <li> <CalendarMonth /> <a href="#">Aluno</a></li>
        <li> <CalendarMonth /> <a href="#">Coordenadores</a></li>
